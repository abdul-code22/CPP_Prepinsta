...
// funtion for checking if the pair exists
...
int main()
{
    ...
    checkBalanced(expr) ? cout << "Balanced" << endl : cout << "Not Balanced" << endl;
    checkBalanced(expr1) ? cout << "Balanced" << endl : cout << "Not Balanced" << endl;
